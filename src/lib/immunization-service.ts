...
export class ImmunizationService {
     ...
     */
    static async generateChildImmunizationRecords(childId: string, birthDate: Date) {
        try {
     ...
     */
    static async getChildImmunizationRecords(childId: string) {
        try {
     ...
     */
    static async updateImmunizationRecord(
        recordId: string,
        data: {
     ...
     */
    static async getUpcomingImmunizations(childId: string) {
        try {
     ...
     */
    static async getOverdueImmunizations(childId: string) {
        try {
            const today = new Date()
     ...
     */
    static async getImmunizationCalendar(childId: string, year?: number, month?: number) {
        try {
            let dateFilter = {}
     ...
     */
    static async getImmunizationStats(childId: string) {
        try {
