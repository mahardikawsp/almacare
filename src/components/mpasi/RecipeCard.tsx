    ...
    return (
        ...
        >
                ...
                {childId && (
                    <button
                        ...
                        className={`absolute top-3 right-3 p-2.5 rounded-full transition-all duration-200 shadow-lg backdrop-blur-sm ${isFavorite
                            ...
                            : 'bg-white/95 text-neutral-600 hover:bg-white hover:scale-105 hover:shadow-xl'
            ...
            <div className="p-4">
                ...
                {/* Recipe Meta */}
                <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 text-sm text-neutral-600 mb-3">
                    ...
                    <div className="px-2 py-1 bg-primary-50 text-primary-700 border border-primary-200 rounded-full text-xs w-fit">
