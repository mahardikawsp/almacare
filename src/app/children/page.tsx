...
function ChildrenContent() {
    ...
    const getGenderIcon = (gender: 'MALE' | 'FEMALE') => {
        if (gender === 'MALE') {
            return (
                <div className="w-12 h-12 bg-gradient-to-br from-blue-400 to-blue-500 rounded-2xl flex items-center justify-center shadow-soft">
            ...
            return (
                <div className="w-12 h-12 bg-gradient-to-br from-pink-400 to-pink-500 rounded-2xl flex items-center justify-center shadow-soft">
                    <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M10 2a8 8 0 100 16 8 8 0 000-16zM8 10a2 2 0 114 0 2 2 0 01-4 0z" clipRule="evenodd" />
                    </svg>
                </div>
        ...
        <AppLayout>
            <div className="max-w-4xl mx-auto">
                ...
                {!showAddForm && !editingChild && children.length < 5 && (
                    <div className="mb-6">
                        <button
                            ...
                            className="flex items-center gap-3 bg-gradient-to-r from-pink-500 to-purple-500 hover:from-pink-600 hover:to-purple-600 text-white font-medium py-3 px-6 rounded-lg transition-all duration-200 hover:scale-105 shadow-medium"
                        >
                ...
                {childrenWithCounts.length === 0 ? (
                    <div className="bg-white rounded-lg p-8 shadow border border-gray-200 text-center">
                        ...
                        <button
                            onClick={() => setShowAddForm(true)}
                            className="bg-gradient-to-r from-pink-500 to-purple-500 hover:from-pink-600 hover:to-purple-600 text-white font-medium py-2 px-4 rounded-lg transition-all duration-200"
                        >
                            Tambah Anak Pertama
                        </button>
                    </div>
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mt-4">
                                            <div className="text-center p-3 bg-blue-50 rounded-lg">
                                                ...
                                                <p className="text-xs text-blue-600">Catatan Pertumbuhan</p>
                                            </div>
                                            <div className="text-center p-3 bg-green-50 rounded-lg">
                                                <p className="text-2xl font-bold text-green-600">
                                                    {child.immunizationRecordsCount}
                                                </p>
                                                <p className="text-xs text-green-600">Imunisasi</p>
                                            </div>
                                            <div className="text-center p-3 bg-purple-50 rounded-lg">
                                                <p className="text-2xl font-bold text-purple-600">
                                                    {child.mpasiFavoritesCount || 0}
                                                </p>
                                                <p className="text-xs text-purple-600">Resep Favorit</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
