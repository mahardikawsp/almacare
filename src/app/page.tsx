    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 to-secondary-50">
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-3">
              ...
              <span className="text-xl font-bold text-primary-700">BayiCare</span>
            </div>
      ...
      <div className="container mx-auto px-4 py-24">
        <div className="text-center">
          ...
          {session && (
            <div className="mb-8 p-4 bg-primary-50 border border-primary-200 rounded-xl max-w-md mx-auto">
            ...
            <div className="bg-white rounded-xl p-6 shadow-soft">
              <div className="text-center">
                <div className="w-16 h-16 bg-primary-100 rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg className="w-8 h-8 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-label="Grafik pertumbuhan">
            ...
            <div className="bg-white rounded-xl p-6 shadow-soft">
              <div className="text-center">
                <div className="w-16 h-16 bg-secondary-100 rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg className="w-8 h-8 text-secondary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-label="Jadwal imunisasi">
            ...
            <div className="bg-white rounded-xl p-6 shadow-soft">
              <div className="text-center">
                <div className="w-16 h-16 bg-accent-100 rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg className="w-8 h-8 text-accent-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-label="Resep MPASI">
          ...
          <div className="mt-12">
            <button
              ...
              type="button"
              className="bg-primary-600 text-white text-lg px-8 py-3 rounded-xl font-semibold hover:bg-primary-700 transition-colors shadow-medium"
            >
